    ...
    <div className="min-h-screen bg-slate-900 relative overflow-hidden">
      ...
      <header className="relative z-10 flex items-center justify-between px-6 py-6 lg:px-12">
        ...
        <nav className="hidden md:flex items-center space-x-8">
          <a href="#sobre" className="text-white hover:text-pink-500 transition-colors">
            Sobre
          </a>
          <a href="#portfolio" className="text-white hover:text-pink-500 transition-colors">
            Portfólio
          </a>
          <a href="#metricas" className="text-white hover:text-pink-500 transition-colors">
            Métricas
          </a>
          <Button
            variant="outline"
    ...
    <div className="flex flex-col lg:flex-row items-center justify-between min-h-[calc(100vh-120px)]">
      <div className="flex-1 max-w-2xl mb-12 lg:mb-0 lg:pr-12">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <Button className="bg-pink-500 hover:bg-pink-600 text-white px-8 py-3 text-lg font-semibold border-2 border-pink-500 flex items-center gap-3">
      ...
      <div className="flex-shrink-0 lg:ml-12">
        <div className="relative">
          <div className="relative w-64 h-64 lg:w-80 lg:h-80 rounded-full overflow-hidden">
            <Image src="/perfil.png" alt="Carla Harumi" fill className="object-cover" priority />
          </div>
        </div>
      </div>
    </div>
...
function SobreSection() {
  return (
    <div className="space-y-16">
      ...
      <div className="space-y-8 text-white text-lg leading-relaxed max-w-4xl mx-auto">
  ...
  return (
    <div className="space-y-16">
      <div className="text-center">
        ...
        <h2 className="text-3xl font-bold text-blue-400">Criação de conteúdo</h2>
      </div>
      ...
      <div className="space-y-8">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            {[1, 2, 3, 4, 5].map((i) => (
              <div key={i} className="aspect-square bg-purple-600 rounded-lg overflow-hidden">
                <Image
                  src={`/placeholder.svg?height=1080&width=1080&text=Frida+${i}`}
                  alt={`Frida Kahlo ${i}`}
                  width={200}
                  height={200}
          ...
          <div className="border-2 border-green-400 rounded-lg p-6">
            ...
            <p className="text-white">
              Criado para ir além da homenagem tradicional, este carrossel usa Frida Kahlo como símbolo de superação,
              incentivando o autoconhecimento e o protagonismo feminino de forma estratégica e inspiradora.
            </p>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-start">
            <div className="bg-slate-800 rounded-lg p-4">
              <div className="aspect-square bg-green-600 rounded-lg overflow-hidden">
                <Image
                  src="/placeholder.svg?height=1080&width=1080&text=Baile+do+Leão"
                  alt="Baile do Leão"
                  width={300}
                  height={300}
                  className="w-full h-full object-cover"
            ...
            <div className="border-2 border-green-400 rounded-lg p-6">
              <h4 className="text-xl font-bold text-green-400 mb-3">Objetivo:</h4>
              <p className="text-white">
                Criado para incentivar a participação dos colaboradores, o post utilizou recursos atualizados do
                Instagram, como carrossel colaborativo, gerando engajamento orgânico por meio do envio de fotos e
                comentários, tudo planejado para ampliar o alcance e fortalecer a presença da marca.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-start">
            <div className="bg-slate-800 rounded-lg p-4">
              <div className="aspect-square bg-purple-600 rounded-lg overflow-hidden">
                <Image
                  src="/placeholder.svg?height=1080&width=1080&text=Carta+Uno"
                  alt="Carta +4 do Uno"
                  width={300}
                  height={300}
                  className="w-full h-full object-cover"
            ...
            <div className="border-2 border-green-400 rounded-lg p-6">
              <h4 className="text-xl font-bold text-green-400 mb-3">Objetivo:</h4>
              <p className="text-white">
                Nesse post foi usada a carta +4 do Uno como metáfora de virada de jogo, apresentando o plano de saúde
                como a "carta na manga" ideal para mudar a situação. Uma estratégia visual direta com foco no objetivo
                de vendas.
              </p>
            </div>
          </div>
        ...
        {/* Storys */}
        <div className="space-y-6">
          <h3 className="text-2xl font-bold text-green-400">Storys</h3>
          <p className="text-white">
            Sequências de storys com foco em vagas e vendas, estruturadas de forma estratégica.
          </p>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="aspect-[9/16] bg-slate-700 rounded-lg overflow-hidden">
                <Image
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 justify-items-center">
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="aspect-[9/16] w-48 bg-slate-700 rounded-lg overflow-hidden">
                <Image
                  src={`/placeholder.svg?height=400&width=225&text=Entrevista+${i}`}
                  alt={`Entrevista ${i}`}
                  width={225}
                  height={400}
                  className="w-full h-full object-cover"
          ...
          <div className="border-2 border-green-400 rounded-lg p-6">
            <h4 className="text-xl font-bold text-green-400 mb-3">Objetivo:</h4>
            <p className="text-white">
              Minha participação como entrevistadora nos vídeos teve como objetivo representar o clima leve e alto
              astral da empresa, comunicando campanhas, ações e acontecimentos internos de forma descontraída. Uma
              estratégia para reforçar os ideais da marca em relação à sua cultura e relação com as pessoas.
            </p>
          </div>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="border-2 border-green-400 rounded-lg p-6">
            <h4 className="text-xl font-bold text-green-400 mb-3">Objetivo:</h4>
            <p className="text-white">
              Proporcionei uma cobertura completa do almoço dos aniversariantes no Coco Bambu, registrando desde a saída
              até o encerramento do evento. O objetivo foi transportar o público, permitindo que acompanhassem e
              vivenciassem os momentos de forma imersiva e próxima.
            </p>
          </div>
          ...
          <div className="space-y-4">
            <h4 className="text-xl font-bold text-blue-400">Cobertura entrega mimo dia das mães</h4>

            <div className="border-2 border-green-400 rounded-lg p-6">
              <h5 className="text-xl font-bold text-green-400 mb-3">Objetivo:</h5>
              <p className="text-white">
                Cobertura da entrega de mimos com registros em foto e vídeo das mães presenteadas na empresa. A ação foi
                retratada de forma leve e afetiva, valorizando o momento e reforçando o cuidado da marca com as pessoas.
              </p>
            </div>
          </div>
          ...
          {/* Terceiro Objetivo */}
          <div className="space-y-4">
            <h4 className="text-xl font-bold text-blue-400">Cobertura Beto Carreiro "Leões no park"</h4>

            <div className="border-2 border-green-400 rounded-lg p-6">
              <h5 className="text-xl font-bold text-green-400 mb-3">Objetivo:</h5>
              <p className="text-white">
                Cobertura completa de todo o percurso de ida ao parque e dos momentos vivenciados, incluindo entrevistas
                com colaboradores, fotos, takes e boomerangs. O conteúdo foi pensado para representar de forma dinâmica
                a experiência vivida pelos ganhadores da campanha.
              </p>
            </div>
          </div>
        </div>
        ...
        {/* Videomaker Mobile */}
        <div className="space-y-6">
          <h3 className="text-2xl font-bold text-pink-500">Videomaker Mobile</h3>
          ...
          <div className="border-2 border-green-400 rounded-lg p-6">
            <h4 className="text-xl font-bold text-green-400 mb-3">Objetivo:</h4>
            <p className="text-white">
              Captação, edição e publicação de vídeos, destacando campanhas e ações da empresa de forma dinâmica e
              alinhada à identidade da marca para redes sociais.
            </p>
          </div>
        </div>
      </div>

  ...
  const prefixVideosStorage = process.env.NEXT_PUBLIC_BASE_STORAGE_URL;
  ...
  export const captacaoEdicao = { 
    storymaker: [
      {
        ...
        source: `${prefixVideosStorage}/storymaker/storymaker-coco-bambu.mp4`,
      },
      {
    ...
    videomakerMobile: [
      {
        source: `${prefixVideosStorage}/videomaker-mobile/videomaker-mobile-1.mp4`,  
      },
      {
        source: `${prefixVideosStorage}/videomaker-mobile/videomaker-mobile-2.mp4`,  
      },
      {
        source: `${prefixVideosStorage}/videomaker-mobile/videomaker-mobile-3.mp4`,  
      },
      {
        source: `${prefixVideosStorage}/videomaker-mobile/videomaker-mobile-4.mp4`,  
      }
    ],
  };
